...
zb.device.platforms.hisense.Input = class extends zb.device.AbstractInput {
	...
	isPointingDeviceSupported() {
		//Disable due to vendor recommendations
		//Although Hisense Smart TV Devices support external input devices such as pointer remote, USB keyboard and mouse, Application developers MUST NOT rely on these.
		return false;
	}
