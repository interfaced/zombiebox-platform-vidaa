...
goog.require('zb.device.platforms.hisense.consts.CountryCodeLocaleMap');
...
zb.device.platforms.hisense.Info = class extends zb.device.AbstractInfo {
	...
	_getLocale() {
		// eslint-disable-next-line new-cap
		const countryCode = window['Hisense_GetCountryCode']();
		return zb.device.platforms.hisense.consts.CountryCodeLocaleMap[countryCode] || 'en';
	}
};
